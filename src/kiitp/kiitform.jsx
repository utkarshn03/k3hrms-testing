    ...
    <form>
      <div className="space-y-10 mb-10">      
        ...
        <div className="border-b border-green-900/10 pb-12 mt-10">
          <h2 className="text-2xl font-semibold leading-6 text-gray-900">Candidate's Personal Information</h2>
          ...
          <div className="sm:col-span-3 text-left">
              ...
              <BiKey className="w-5 h-5"/> {" "}Admission Ref. No. 
              </label>
              <div className="mt-2">
