          ...
          {records.map((d, i) => (
            <tr key={i}>
              ...
              <td className="gap-x-4">
                <button className="text-white bg-gray-500 rounded-md px-2 py-2 mx-0.5 hover:bg-gray-700">
                  {" "}
                  View{" "}
                </button>
                <button
                  onClick={(e) => handleUpdate(d.id)}
                  className="text-white bg-blue-500 rounded-md px-2 py-2 mx-0.5 hover:bg-blue-700"
                >
                  {" "}
                  Update
                </button>
                <button
                  ...
                  className="text-white bg-red-500 rounded-md px-2 py-2 mx-0.5 hover:bg-red-700"
                >
                  {" "}
                  Delete
                </button>
